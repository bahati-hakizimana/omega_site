...
import heroImg from "../components/assets/images/AUCA2.jpg"
              ...
              <div>
                <div>
                  <h1 className='text-4xl leading-tight text-black font-semibold'>
                    Exprol your academic journey with us
                  </h1>
                  {/* <h3 className='text-lg mt-3'>Exprol</h3>
                  <span className='text-[14px]'> your academic journey with us</span> <br /> */}
                  <p>Harness the power of our innovative course recommandation system to tailor your  academic journey with Auca.</p> <br />


                  <button className=" bg-blue-700 px-4 py-2 rounded-full mt-2 text-white">Apply Now</button>
                </div>
              ...
              <div className='content'>
                <button className='bg-white shadow-md absolute top-56 left-0 z-30 p-2 flex items-center rounded-md'>
                  ...
                  <div className='text flex flex-col items-start px-4'>
                    <span className='text-sm text-black'>Connectet students</span>
