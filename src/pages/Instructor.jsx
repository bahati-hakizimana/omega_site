      ...
      <section className='instructor mb-16'>
        <div className='container'>
          {/* <div className='heading py-12 text-center w-2/3 m-auto md:w-full'>
            ...
            <span className='text-[14px] mt-2 block'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nam temporibus error est explicabo optio architecto dolores ducimus odit placeat hic vitae sint, vero velit quo in, quia alias. In, assumenda?</span>
          </div> */}
          ...
          <div className='content'>
            <div className='heading py-12 text-center w-2/3 m-auto md:w-full'>
              ...
              <span className='text-[14px] mt-2 block'>Be among The bright students in the world.</span>
            </div>
            <div className='content grid grid-cols-4 gap-5 md:grid-cols-2'>
              <InstructorCard color='text-red-500' icon={<FaUsers size={40} />} title='10,000' desc='Total student' />
              <InstructorCard color='text-orange-500' icon={<GiEvilBook size={40} />} title='8000' desc='Physical learners' />
              <InstructorCard color='text-indigo-500' icon={<GiWorld size={40} />} title='2000' desc='Online Learners' />
              <InstructorCard color='text-purple-500' icon={<FaGraduationCap size={40} />} title='2000' desc='Graduated last year' />
